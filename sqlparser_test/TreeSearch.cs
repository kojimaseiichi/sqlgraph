...
namespace sqlparser
{
    ...
    public class PlsEdge : QuickGraph.Edge<PlsVertex>
    {
        public string ID { get; private set; }

        public PlsEdge(string id, PlsVertex source, PlsVertex target) : base(source, target)
        {
            this.ID = id;
        }
    }
    ...
    public static class TreeSearch
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Walk> dfs(IParseTree root)
        {
            ...
            while(stack.Count > 0)
            {
                ...
                if (index < parent.ChildCount)
                {
                    ...
                    yield return new Walk { current = child, parent = parent, depth = depth };
        ...
        /// <param name="root"></param>
        /// <returns></returns>
        public static IEnumerable<Walk> bfs(IParseTree root)
        {
